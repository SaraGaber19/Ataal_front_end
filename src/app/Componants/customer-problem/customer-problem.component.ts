...
@Component({
  selector: 'app-customer-problem',
  templateUrl: './customer-problem.component.html',
  styleUrls: ['./customer-problem.component.scss'],

})
export class CustomerProblemComponent implements OnInit {
...
//  Sections
 ...
 return;
    ...
    this.data.append("Customer_ID","1")
